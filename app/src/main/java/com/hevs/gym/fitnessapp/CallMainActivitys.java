...
public class CallMainActivitys {
    ...
    public static void showExersisePlanFromUser(View v, AppCompatActivity previusActivity, int userID)
    {
        Intent inten = new Intent(previusActivity, ExcersisesCatActivity.class);
        inten.putExtra("Titel", "User "+userID); //Später name
        inten.putExtra("isMyPlan", true);
    ...
    //Show the exercises split in categories from user Plan
    public static void showExersise(View v, AppCompatActivity previusActivity, int exID)
    {
